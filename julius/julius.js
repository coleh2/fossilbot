var window = { AudioContext: require('web-audio-engine').StreamAudioContext};
...
module.exports = (function(window, navigator, undefined) {
    var postBuffer = function() {
      ...
      return function(e) {
        ...
        console.log('posting buffer now-- here is what we see of it: ' + buffer);
    ...
    var Julius = function(pathToDfa, pathToDict, options) {
      ...
      this.recognizer = new Worker(options.pathToWorker || 'julius/worker.js');

      this.recognizer.onmessage = function(e) {
          console.log('here\'s what julius.js sees as e: ' + JSON.stringify(e));
        if(!e.data) { return }
