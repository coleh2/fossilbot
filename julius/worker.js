var importScripts = require('import-scripts');

var master = self;
var vm, fs;
master.postMessage({type: "hi"});
...
importScripts('julius/recognizer.js', 'julius/listener/resampler.js', 'julius/listener/converter.js');
...
master.onmessage = (function() {
  ...
  return function(e) {
      console.warn('here is worker.js\'s copy of e: ' + e);
    if (e.data.type === 'begin') {
      ...
      if (typeof e.data.pathToDfa === 'string' &&
        ...
        dfa = 'julius/voxforge/sample.dfa';
        dict = 'julius/voxforge/sample.dict';
      }
