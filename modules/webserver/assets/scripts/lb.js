...
var sms = d[i].r.sms
    lvl = d[i].r.level
    mxp = d[i].r.score
    avatarUrl = function(x) {if (x.discord.avatar) {return 'https://cdn.discordapp.com/avatars/' + x.discord.id + '/' + x.discord.avatar} else { return 'https://cdn.discordapp.com/embed/avatars/' + (x.discord.discriminator % 5) + '.png' }}(d[i])
